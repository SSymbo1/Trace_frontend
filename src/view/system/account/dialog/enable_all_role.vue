...
import {enableAllAccount} from "@/api/system/account.js";
import {ElMessage} from "element-plus";
import {enableAllRole} from "@/api/system/role.js";
...
const submitFormData = async () => {
  ...
  enableAllRole(formData.value).then(resp => {
    if (resp.code === 200) {
...
<template>
  <el-dialog title="请求启用所有角色" v-model="dialogVisible" width="27%" @close="closeDialog">
    <el-form
