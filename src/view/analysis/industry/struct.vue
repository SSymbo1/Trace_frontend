...
import {getStructData} from "@/api/analysis/struct.js";
    ...
    <el-form
      ...
      <el-row>
        ...
        <el-col :span="8">
          ...
          <el-button type="primary" :icon="DocumentAdd" @click="">生成分析报告</el-button>
        </el-col>
      </el-row>
      <el-divider/>
    </el-form>
        ...
        <el-table-column label="操作" width="100px">
          <template #default="scope">
            <el-tooltip content="查看" effect="light">
              <el-button type="primary" :icon="Search" circle @click=""/>
            </el-tooltip>
          </template>
        </el-table-column>
        <template #empty>
