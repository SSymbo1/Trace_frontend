...
import {getAppearsPaged} from "@/api/segment/segment.js";
import Add_appears_excel from "@/view/segment/manage/dialog/add_appears_excel.vue";
import Appears_advanced_search from "@/view/segment/manage/drawer/appears_advanced_search.vue";
import Qr_code from "@/view/segment/manage/dialog/qr_code.vue";

const tabBread = ref(bread.appears)
const data = ref()
const loading = ref()
const query = ref({
  pageSize: 5,
...
const requestData = async () => {
  loading.value = true
  getAppearsPaged(query.value).then(resp => {
    if (resp.code === 200) {
...
<template>
  <page_container title="">
    ...
    <appears_advanced_search ref="info" @update:data="searchHandler"></appears_advanced_search>

    <add_appears_excel ref="excel" @success="uploadExcelSuccessHandler"></add_appears_excel>
