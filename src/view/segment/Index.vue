...
import {getSegmentMenue} from "@/api/menue/menue.js";
...
import {userLogout} from "@/api/welcome/welcome.js";
      ...
      <el-header>
        <el-menu
          ...
          <el-menu-item index="0" @click="router.push('/')">
            ...
            <span style="margin-left: 15px;font-weight: bold;color: #A8ABB2">追溯环节管理</span>
          </el-menu-item>
          <div class="flex-grow"/>
