...
<template>
  <el-drawer title="高级搜索" v-model="drawerVisible" direction="ttb" @close="closeDrawer">
    <el-form
        ...
        label-width="auto"
        :inline="true">
      <el-form-item label="供销商名称" prop="name">
        <el-input v-model="formData.name" clearable placeholder="请输入供销商名称"/>
      </el-form-item>
      <el-form-item label="供销商编号" prop="code">
        <el-input v-model="formData.code" clearable placeholder="请输入供销商编号"/>
      </el-form-item>
